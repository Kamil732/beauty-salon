	...
	return (
		<PageHero>
			<PageHero.Body>
				<Card>
					<Card.Title>
						Privacy Policy for Salon Fryzjerski Damian Kwiecień
					</Card.Title>
					<Card.Body>
						<p>
							At Salon Fryzjerski Damian Kwiecień, accessible from
							http://app.com:8000/, one of our main priorities is
							the privacy of our visitors. This Privacy Policy
							document contains types of information that is
							collected and recorded by Salon Fryzjerski Damian
							Kwiecień and how we use it.
						</p>
						...
						<p>
							...
							and/or collect in Salon Fryzjerski Damian Kwiecień.
							This policy is not applicable to any information
							collected offline or via channels other than this
							website. Our Privacy Policy was created with the
							help of the{' '}
						...
						<p>
							Salon Fryzjerski Damian Kwiecień follows a standard
						...
						<p>
							Like any other website, Salon Fryzjerski Damian
							Kwiecień uses 'cookies'. These cookies are used to
							store information including visitors' preferences,
							and the pages on the website that the visitor
							accessed or visited. The information is used to
							optimize the users' experience by customizing our
						...
						<p>
							...
							for each of the advertising partners of Salon
							Fryzjerski Damian Kwiecień.
						</p>
						...
						<p>
							...
							advertisements and links that appear on Salon
							Fryzjerski Damian Kwiecień, which are sent directly
							to users' browser. They automatically receive your
							IP address when this occurs. These technologies are
						...
						<p>
							Note that Salon Fryzjerski Damian Kwiecień has no
							access to or control over these cookies that are
						...
						<p>
							Salon Fryzjerski Damian Kwiecień's Privacy Policy
							does not apply to other advertisers or websites.
							Thus, we are advising you to consult the respective
							Privacy Policies of these third-party ad servers for
						...
						<p>
							...
							pieces of personal data that a business has
						...
						<p>
							...
							is inaccurate. You also have the right to request
							that we complete the information you believe is
							incomplete.
						</p>
						<p>
						...
						<p>
							Salon Fryzjerski Damian Kwiecień does not knowingly
