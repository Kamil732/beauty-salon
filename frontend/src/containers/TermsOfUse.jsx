			...
			<Card>
				...
				<Card.Body>
					<p>
						...
						http://app.com:8000/, one of our main priorities is the
						privacy of our visitors. This Privacy Policy document
						contains types of information that is collected and
						recorded by Salon Fryzjerski Damian Kwiecień and how we
						use it.
					</p>
					...
					<p>
						...
						collect in Salon Fryzjerski Damian Kwiecień. This policy
						is not applicable to any information collected offline
						or via channels other than this website. Our Privacy
					...
					<p>
						Like any other website, Salon Fryzjerski Damian Kwiecień
					...
					<p>
						...
						each of the advertising partners of Salon Fryzjerski
						Damian Kwiecień.
					</p>
					...
					<p>
						...
						on Salon Fryzjerski Damian Kwiecień, which are sent
						...
						campaigns and/or to personalize the advertising content
						that you see on websites that you visit.
					</p>

					<p>
						Note that Salon Fryzjerski Damian Kwiecień has no access
						to or control over these cookies that are used by
					...
					<p>
						Salon Fryzjerski Damian Kwiecień's Privacy Policy does
